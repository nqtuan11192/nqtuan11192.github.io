...
const GiftBox: React.FC = () => {
    ...
    const brideInfo: BankingInfo = {
        name: 'Chú Rể',
        accountName: 'LÊ ĐÌNH LUÂN',
        accountNumber: '13052025',
        bank: 'VIB',
        qrCode: '/images/qr-groom.png' // You'll need to add your QR code image
    };

    const groomInfo: BankingInfo = {
        name: 'Cô Dâu',
        accountName: 'Trần Thị Kim Dung',
        accountNumber: '083190858',
        bank: 'VIB',
        qrCode: '/images/qr-bride.png' // You'll need to add your QR code image
    };
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="border-4 border-rose-400 rounded-xl p-6 bg-rose-50">
                                    ...
                                    <div className="bg-white p-4 rounded-lg mb-4 flex items-center justify-center">
                                        <div className="w-64 h-64 bg-gradient-to-br from-rose-100 to-rose-200 rounded-lg flex items-center justify-center border-2 border-rose-300">
                                            <div className="text-center">
                                                ...
                                                <p className="text-xs text-slate-400 mt-1">Thêm ảnh QR vào<br />/public/images/qr-groom.png</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white p-4 rounded-lg mb-4 flex items-center justify-center">
                                        <div className="w-64 h-64 bg-gradient-to-br from-rose-100 to-rose-200 rounded-lg flex items-center justify-center border-2 border-rose-300">
                                            <div className="text-center">
                                                ...
                                                <p className="text-sm text-slate-500">QR Code</p>
                                                <p className="text-xs text-slate-400 mt-1">Thêm ảnh QR vào<br />/public/images/qr-bride.png</p>
                                            </div>
                                        </div>
                                    </div>
